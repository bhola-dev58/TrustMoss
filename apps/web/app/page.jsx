...
function OperationsConsole({ isDemoMode, onExitDemo }) {
  ...
  return (
    <div className="min-h-screen bg-[#121212] text-[#FFFFFF] flex flex-col font-sans">
      ...
      <header className="border-b border-[#333333] bg-[#1E1E1E]/95 backdrop-blur-md sticky top-0 z-30 px-3 sm:px-6 py-3 flex flex-col md:flex-row md:items-center justify-between gap-3 shadow-lg">
          ...
          <div className="flex items-center gap-2.5 sm:gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-base font-bold tracking-tight text-[#FFFFFF] flex items-center gap-1.5">
              ...
              <p className="text-[11px] sm:text-xs text-[#9AA0A6] line-clamp-1">Zero-Latency Trust &amp; Guardrail Gateway</p>
            </div>
          </div>
        ...
        {/* Global Navigation Tabs - Horizontally Scrollable on Mobile */}
        <div className="flex items-center bg-[#121212] border border-[#333333] rounded-xl p-1 text-xs font-medium overflow-x-auto no-scrollbar w-full md:w-auto shrink-0 gap-0.5">
          <button
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-lg flex items-center gap-1.5 transition-all whitespace-nowrap cursor-pointer ${
              activeTab === 'attack'
                ...
                : 'text-[#9AA0A6] hover:text-rose-400'
            }`}
          >
        ...
        <div className="hidden md:flex items-center gap-2">
          ...
          <button
            ...
            className="px-3 py-1.5 bg-[#242424] hover:bg-[#333333] border border-[#333333] text-xs font-medium rounded-xl flex items-center gap-2 text-[#9AA0A6] hover:text-[#FFFFFF] transition-colors cursor-pointer"
          >
