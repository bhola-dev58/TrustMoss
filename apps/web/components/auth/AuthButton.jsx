...
export default function AuthButton() {
    ...
    return (
      ...
      >
        ...
        <div className="flex flex-col text-left">
          <span className="font-semibold text-[#FFFFFF] leading-tight max-w-[70px] sm:max-w-[110px] truncate text-[11px] sm:text-xs">
            {displayName}
          </span>
          <span className="text-[9px] sm:text-[10px] text-[#FFC107] flex items-center gap-1 font-mono">
        ...
        <button
          onClick={logout}
          title="Sign Out"
          className="ml-0.5 sm:ml-1 p-1 text-[#9AA0A6] hover:text-rose-400 hover:bg-[#333333] rounded-lg transition-colors cursor-pointer"
        >
  ...
  return (
    <button
      ...
      className="px-2.5 sm:px-3 py-1.5 bg-[#242424] hover:bg-[#333333] border border-[#333333] hover:border-[#FF8C00]/40 text-xs font-semibold rounded-xl flex items-center gap-1.5 sm:gap-2 text-[#FFFFFF] transition-all shadow-sm disabled:opacity-50 cursor-pointer font-sans shrink-0"
    >
      ...
      <span className="hidden sm:inline">{signingIn ? 'Connecting...' : 'Sign in with Google'}</span>
