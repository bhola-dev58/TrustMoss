...
export default function HitlQueueModal({ isOpen, onClose, flaggedItems = [], onResolve }) {
  ...
  return (
    <div data-testid="hitl-queue-modal" className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          ...
          {flaggedItems.length === 0 ? (
            ...
            <div className="space-y-4">
              <div className="p-3 bg-rose-950/30 border border-rose-900/40 rounded-xl space-y-1.5">
                ...
                <p className="text-sm font-medium text-slate-100">{selectedItem?.query || selectedItem?.text || 'Off-topic or low-grounded query'}</p>
